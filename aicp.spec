...
a = Analysis(
    ...
    hiddenimports=[
        ...
        'fal_image_to_image.config.constants',
        'fal_image_to_image.models',
        'fal_image_to_image.models.base',
        'fal_image_to_image.models.photon',
        'fal_image_to_image.models.kontext',
        'fal_image_to_image.models.seededit',
        'fal_image_to_image.models.clarity',
        'fal_image_to_image.models.nano_banana',
        'fal_image_to_image.models.gpt_image',
        'fal_image_to_image.generator',
        'fal_image_to_image.utils',
        'fal_image_to_image.utils.file_utils',
        'fal_image_to_image.utils.validators',
        'fal_video_to_video',
        ...
        # Google AI SDKs (needed for aicp analyze-video -t describe)
        'google',
        'google.genai',
        'google.genai.types',
        'google.genai.errors',
